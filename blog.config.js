...
const BLOG = {
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai'
    '-apple-system', '"PingFang SC"', 'Bitter', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  FONT_SERIF: [// 衬线字体 例如'LXGW WenKai'
    '"Times New Roman"', '"Noto Serif SC"', 'Bitter', 'SimSun', 'Times', 'serif',
  ...
  PRISM_THEME_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-coldark-dark.css', // 只需要改 themes 后面的 css 文件名就行。代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
